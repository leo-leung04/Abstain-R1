...
--------------------------------------------------
DOMAIN & DATASET BEHAVIOR (FALSEQA-STYLE GENERAL KNOWLEDGE QA)
--------------------------------------------------
1. The FalseQA dataset contains general knowledge questions that are answerable
...
2. When reasoning, you MUST:
   ...
   - Note that questions may contain minor spelling errors or informal language,
...
3. Questions may involve:
   ...
   - Comparative reasoning (comparing different options),
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Clean FalseQA answerable data and generate DeepSeek CoT outputs (JSONL).",
    )
    parser.add_argument(
        "--input-path",
        default=str(BASE_DIR / "falseqa_answerable_100_forward.json"),
        help="Path to the input JSON with answerable entries.",
    )
    parser.add_argument(
        "--output-path",
        default=str(BASE_DIR / "falseqa_answerable_clean_deepseek.jsonl"),

...
that logically leads from the context to the correct answer.
...
2. When reasoning, you MUST:
   - Read the context carefully and identify key information
   - Determine which part of the context contains the answer
   - Extract the answer directly from the context text
   - Ensure the answer accurately reflects what is stated in the context

3. Reading comprehension approach:
   - Identify what the question is asking for
   - Scan through the context to locate relevant information
...
2. Evidence-Centered Reasoning:
   ...
   - Systematically go through the context and identify relevant information.
...
3. Granularity:
   ...
   - Make it clear how you located the relevant information in the context.
...
Then, step by step, go through the context, identify relevant information,
and explain how you extract the answer from the context.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Clean SQuAD2 answerable data and generate DeepSeek CoT outputs (JSONL).",
    )
    parser.add_argument(
        "--input-path",
        default=str(BASE_DIR / "squad2_answerable_100_forward.json"),
        help="Path to the input JSON with answerable entries.",
    )
    parser.add_argument(
        "--output-path",
        default=str(BASE_DIR / "squad2_answerable_clean_deepseek.jsonl"),
